...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Employer.logoURL'
        db.add_column(u'student_employer', 'logoURL',
                      self.gf('django.db.models.fields.URLField')(default='/static/img/default_employer.png', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Employer.logoURL'
        db.delete_column(u'student_employer', 'logoURL')
