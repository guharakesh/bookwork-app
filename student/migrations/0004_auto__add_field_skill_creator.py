...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'student_skill', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='creator', to=orm['student.Student']),
                      keep_default=False)
    ...
    models = {
        ...
        u'student.skill': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'creator'", 'to': u"orm['student.Student']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
