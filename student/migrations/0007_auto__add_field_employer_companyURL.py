...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Employer.companyURL'
        db.add_column(u'student_employer', 'companyURL',
                      self.gf('django.db.models.fields.URLField')(default='example.com', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Employer.companyURL'
        db.delete_column(u'student_employer', 'companyURL')
    ...
    models = {
        ...
        u'student.employer': {
            ...
            'companyURL': ('django.db.models.fields.URLField', [], {'default': "'example.com'", 'max_length': '200'}),
