...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field skills on 'Student'
        m2m_table_name = db.shorten_name(u'student_student_skills')
    ...
    def backwards(self, orm):
        # Removing M2M table for field skills on 'Student'
        db.delete_table(db.shorten_name(u'student_student_skills'))
